...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 03, 2020 at 02:01 PM
...
INSERT INTO `diagnosticsmaster` (`test_id`, `test_name`, `rate`) VALUES
(1, 'LIPID', 1500),
(2, 'CBP', 2000),
(3, 'ECHO', 4000),
(4, 'ECG', 3000),
(5, 'HAEMOGRAM', 2000),
(6, 'LIVER PROFILE', 1100),
(7, 'RENAL', 1100),
(8, 'MAMMOGRAM', 1500),
(9, 'URINE ANALYSIS', 1600),
(10, 'ULTRASONOGRAM', 1800);

-- --------------------------------------------------------

--
-- Table structure for table `diagnosticstable`
--
...
--
-- Dumping data for table `diagnosticstable`
--

INSERT INTO `diagnosticstable` (`ws_pat_id`, `ws_test_id`) VALUES
(145689765, 6),
(145689765, 3),
(123456789, 8),
(123456789, 9),
...
INSERT INTO `medicines` (`ws_pat_id`, `ws_med_id`, `quan_issued`) VALUES
(145689765, 8, 2),
(145689765, 4, 3),
(123456789, 9, 2),
(123456789, 8, 5);
...
--
-- Dumping data for table `medicinesmaster`
--

INSERT INTO `medicinesmaster` (`med_id`, `med_name`, `quantity`, `rate`) VALUES
(1, 'ACYCLOVIR', 100, 1875),
(2, 'DAUNORUBICIN', 10, 400),
(3, 'OXALIPLATIN', 18, 1078),
(4, 'VINCRISTINE', 25, 418),
(5, 'CARBOPLATIN', 50, 319),
(6, 'GEMCITABINE', 10, 316),
(7, 'VINORELBINE', 60, 1286),
(8, 'ONDANSETRON', 7, 101),
(9, 'PACLITAXEL', 3, 139),
(10, 'LETROZOLE', 41, 517);
...
CREATE TABLE `patient` (
  ...
  `ws_pat_id` int(11) NOT NULL,
  `ws_pat_name` varchar(25) NOT NULL,
  `ws_adrs` varchar(30) NOT NULL,
  `ws_age` int(11) NOT NULL,
  `ws_doj` varchar(30) NOT NULL,
  `ws_rtype` text NOT NULL,
  `city` text NOT NULL,
  `state` text NOT NULL,
...
INSERT INTO `patient` (`ws_ssn`, `ws_pat_id`, `ws_pat_name`, `ws_adrs`, `ws_age`, `ws_doj`, `ws_rtype`, `city`, `state`, `status`) VALUES
(123456789, 531074693, 'SN', '401, Shree Hanuman Darshan', 45, '2020-07-08', 'Single', 'Thakurli', 'Maharashtra', 'Active'),
(145689765, 145689765, 'Virat Sharma', 'Raj Bhavan, Malabar Hill', 50, '2020-02-26', 'Semi', 'Mumbai', 'Maharashtra', 'Active'),
(748986541, 748986541, 'Anil Kumble', 'Bangalore, Karnataka', 45, '2020-02-07', 'Single', 'Mumbai', 'Maharashtra', 'Active');
...
INSERT INTO `userstore` (`user_id`, `username`, `password`, `user_type`) VALUES
(1, '2020ADEviraj44', 'pbkdf2:sha256:150000$ce50tzeL$13964f6aa0d9c33c9b327909b38f90dfd82976a57001f195edaee666f7128d1d', 'admissionDeskExecutive'),
(2, '2020Parpi44', 'pbkdf2:sha256:150000$odOj0Cpi$f9f5eb009aab43f0f0c19d87b1ff1c093d2023c159d50f4990086f1019f138cb', 'pharmacist'),
(3, '2020DEsagar44', 'pbkdf2:sha256:150000$6GEjacBa$f54728fcd5464b60d008fed7629addb3e07f72f0bafd945772b3982f34a17bc9', 'diagnosticExecutive'),
(4, '2020ADEaaditya44', 'pbkdf2:sha256:150000$FDgksGbW$96eae82813ea073d49562c2c9a02b47144e2014f96fbbd89f293bd662d0d9acc', 'admissionDeskExecutive'),
(5, '2020DEriya44', 'pbkdf2:sha256:150000$ri5AksVE$b3b786cd65f345310487461d6e535bcca3ed1f36f9a9bfefc4f3b1c3e45fee37', 'diagnosticExecutive');
...
--
-- Indexes for table `diagnosticstable`
--
ALTER TABLE `diagnosticstable`
  ADD KEY `fk_pat_id` (`ws_pat_id`),
  ADD KEY `fk_test_id` (`ws_test_id`);

--
-- Indexes for table `medicines`
--
ALTER TABLE `medicines`
  ADD KEY `fk_ws_pat_id` (`ws_pat_id`),
  ADD KEY `fk_ws_med_id` (`ws_med_id`);
...
--
ALTER TABLE `patient`
  ADD PRIMARY KEY (`ws_ssn`),
  ADD UNIQUE KEY `ws_pat_id` (`ws_pat_id`);
...
--
-- Constraints for table `diagnosticstable`
--
ALTER TABLE `diagnosticstable`
  ADD CONSTRAINT `fk_pat_id` FOREIGN KEY (`ws_pat_id`) REFERENCES `patient` (`ws_pat_id`),
  ADD CONSTRAINT `fk_test_id` FOREIGN KEY (`ws_test_id`) REFERENCES `diagnosticsmaster` (`test_id`);

--
-- Constraints for table `medicines`
--
ALTER TABLE `medicines`
  ADD CONSTRAINT `fk_ws_med_id` FOREIGN KEY (`ws_med_id`) REFERENCES `medicinesmaster` (`med_id`),
  ADD CONSTRAINT `fk_ws_pat_id` FOREIGN KEY (`ws_pat_id`) REFERENCES `patient` (`ws_pat_id`);
COMMIT;
